...
class RatingRepository extends ServiceEntityRepository
{
    ...
    public function getrating($game,$user)
    {
        try {
            return $this->createQueryBuilder('g')->where('g.iduser = :user')->andWhere('g.idgame = :game')
                ->setParameter('user', $user)->setParameter('game', $game)->getQuery()->getSingleResult();
